...
- **`v1/mods/<slug>/readme.md`** — the rich markdown readme, lazy-fetched by
  the app when a mod's detail page opens (the index carries its
  convention-generated `readmePath`).
